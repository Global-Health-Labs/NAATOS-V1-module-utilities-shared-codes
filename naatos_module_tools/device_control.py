...
class NAATOS_MODULE_CONTROLLER:
    _sercdc = None;
    status_data = {};
    def __init__(self):
        pass;
    ...
    def toMSCandWait(self):
        drivelist_pre = naatos_module_tools.usb_file_utils_lite.getDriveList2();
        ...
        while(True):
            ...
            time.sleep(1.0);
            drivelist_post = naatos_module_tools.usb_file_utils_lite.getDriveList2();
